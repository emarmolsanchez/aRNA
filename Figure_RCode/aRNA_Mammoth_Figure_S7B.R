...
UMAP_table_small = rbind(UMAP_table_small, Thy_predict, Dog_predict)
UMAP_table_small$Size = c(rep(2, 71), rep(4, 7))
UMAP_table_small$Alpha = c(rep(0.7, 78))
...
UMAP_table_small$Shape = factor(UMAP_table_small$Shape, levels=c(15, 11, 23, 30))
...
color_final_small = c(rep("#DB6443", 4), rep("plum", 4), rep("#F0C57F",8), rep("goldenrod3",4), rep("goldenrod4",4), rep("lavender",4), 
                      ...
                      rep("palegreen1",4), rep("palegreen3",4), rep("olivedrab2",4), rep("olivedrab4",4), rep("darkolivegreen3",4), rep("black", 7))
