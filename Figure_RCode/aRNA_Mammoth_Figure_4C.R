...
Dog_predict$Shape = factor(c(rep(23,3), rep(21, 2)))
...
UMAP_table$Shape = factor(UMAP_table$Shape, levels=c(15, 28, 1))
UMAP_table$Size = c(rep(2, 104), rep(2.5, 8), rep(4, 4))
UMAP_table$Alpha = c(rep(0.5, 112), rep(1, 4))

#Remove Mammoths 1i, 4 & 10
UMAP_table = UMAP_table[1:113,]
...
#Figure 4C
pdf("aRNA_Mammoth_Figure_4C.pdf", height = 70/25.4, width = 82.5/25.4)
